...
- An advanced fail-closed content reviewer for cross-field contradictions, unsupported certainty, vague or unfinished language, source-language overclaims, assessment-rationale conflicts, stale repository counts, broken governed links, and machine-to-document invariant drift.
