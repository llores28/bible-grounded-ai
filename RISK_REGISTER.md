...
| R-007 | Direct, indirect, digital, or AI-mediated deception rewarded as kindness, persuasion, privacy, or expediency | Hard-floor rule 9; validated 28-category taxonomy plus catch-all; runtime refusal patterns; truthful refusal, privacy, confidentiality, and lawful-reporting distinctions | Zero accepted intentional false impressions; 100% taxonomy and confidentiality vector pass rates | Deterministic public vectors implemented; independent model evaluation pending |
| R-008 | Contradictory, ambiguous, stale, or unsupported content passes review | Independent answer-content verifier; repository invariant audit; source-language support check; exact issue locations and suggested corrections; no silent doctrinal rewrite | 100% advanced content-review pass rate; zero blocking repository-content issues | Deterministic reviewer implemented; independent model and scholar evaluation pending |
